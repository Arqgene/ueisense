...
const SPECIALIST_CENTERS = AGARWAL_CENTERS.map((c) => ({
  id: c.id,
  name: c.clinicName,
  director: c.name,
...
const INITIAL_REFERRALS = [
  ...
  },
  {
    ...
    specialist_name: "Dr. Ramamurthy Sundar, DNB, FRCS",
    clinic_name: "Dr. Agarwal's Eye Hospital - Indiranagar (Bengaluru)",
    specialty: "Director — Vitreo-Retina & Posterior Uveitis",
    referral_priority: "Immediate / High",
  ...
  },
  {
    ...
    specialist_name: "Dr. V. Rajeshwari, MS",
    clinic_name: "Dr. Agarwal's Eye Hospital - Banjara Hills (Hyderabad)",
    specialty: "Senior Cornea & Anterior Segment Specialist",
    referral_priority: "Moderate (< 48 hrs)",
