...
export function normalizePatient(p) {
  ...
  return {
    ...
    sex: p.sex || "Other",
    phone: p.phone || "",
    assigned_doctor_id: p.assigned_doctor_id || "DR-AG-01",
    assigned_doctor_name: p.assigned_doctor_name || "Dr. Soundari S., MS, FMRF",
    hospital_branch: p.hospital_branch || "Dr. Agarwal's Eye Hospital - Cathedral Road (Chennai Main)",
