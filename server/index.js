...
app.get("/api/referrals", (_req, res) => {
  const refs = db.prepare(`
    SELECT r.*, p.name as patient_name, p.age, p.sex, p.risk_tier, p.severity_class
...
// ── Proxy /predict & /api/predict to Python FastAPI ML Backend ────────────────
...
// ── Proxy /predict-image & /api/predict-image to Python FastAPI ML Backend ───
